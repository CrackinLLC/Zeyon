import type { EmitterOptions } from '../../../_imports/emitter';
import type Emitter from '../../../emitter';
import type { Attributes } from '../../../util/attributes';
import type BaseModel from '../../_baseModel';
import type { ModelType } from '../../_imports/_baseModel';
...
export interface BaseCollectionOptions extends EmitterOptions {
  ids?: string[];
  fetchAllData?: boolean;
  filter?: CollectionFilterOptions;
}

export interface CollectionLike<M extends BaseModel = BaseModel> extends Emitter {
  model: M;
  ...
  newModel(attributes: Partial<Attributes> | Partial<Attributes>[], silent?: boolean): Promise<this>;
